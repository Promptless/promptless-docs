...
* **Enhanced Random Number API:** Added a new `/api/random/range` endpoint that allows you to generate random numbers within a custom range by specifying minimum and maximum values. Check out the [API Reference](/api-reference) for details.
