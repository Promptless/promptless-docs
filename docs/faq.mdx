...
### What account information is available through the API?

When accessing account information through our API, you'll receive:
- Organization ID
- Notification settings
- Stripe customer ID (useful for billing integrations)
