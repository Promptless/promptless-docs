...
## Step 3: Using Follow-on Requests

When reviewing documentation updates in the Promptless dashboard, you may want to request additional changes or refinements to the initial suggestions. The follow-on request feature allows you to provide specific feedback and instructions for further improvements.

To use follow-on requests in the web interface:

1. Navigate to the documentation update you want to refine
2. Review the suggested changes
3. Use the follow-on request input field to provide specific instructions (e.g., "Please add more examples for the API endpoints" or "Expand the troubleshooting section with common errors")
4. Submit your request
5. Promptless will process your instructions and update the documentation suggestions accordingly

Follow-on requests are particularly useful when the initial documentation update is good but needs specific adjustments or additional information. You can also make follow-on requests through PR comments if you're using GitHub integration with auto-publish enabled.
