...
For GitHub-based projects, you can configure how Promptless creates pull requests:
- Enable auto-publish to automatically create pull requests with documentation changes, rather than requiring manual review through the dashboard
- Specify a custom PR template file (e.g., `.github/pull_request_template.md`) to control how Promptless formats its pull requests
