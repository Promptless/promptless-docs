...
After creating your project, you can configure how you want to be notified about Promptless suggestions. Visit the User Settings tab to set up your notification preferences:

* **Slack Notifications**: Configure a specific Slack channel where Promptless will send all documentation update suggestions. This helps your team stay informed and review suggestions in one place.
...
These settings help ensure that your team stays informed about documentation updates while maintaining your preferred workflow.
