...
- Bitbucket: Promptless runs upon opening a PR in any of the Bitbucket repositories you specify in the Project
...
For GitHub and Bitbucket-based projects, you can enable auto-publish to automatically create pull requests with documentation changes. When enabled, Promptless will create a new PR with suggested documentation updates whenever it detects necessary changes, rather than requiring manual review and PR creation through the dashboard.
