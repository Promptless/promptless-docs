...
Before you start, you'll need a Promptless account. You can create a Promptless account at accounts.gopromptless.ai. If you've got more than 200 articles in your docs, or if you use uncommon triggers or documentation sources, you will need to contact our team at  [hello@gopromptless.ai](mailto:hello@gopromptless.ai) to get access. Once you have an account, you can configure Promptless in just two easy steps: (1) you'll set up integrations to connect Promptless to your triggers, context sources, and docs, and (2) you'll create a project to tell Promptless what to do when it's triggered.
