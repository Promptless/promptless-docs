...
Promptless uses Slack's [official App authentication](https://api.slack.com/authentication) with granular permission scopes. You can revoke access at the workspace or channel level through your Slack settings.
