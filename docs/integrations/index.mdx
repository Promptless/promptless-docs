...
- [Bitbucket](./bitbucket): Trigger based on Pull Requests and research based on code functionality
- [Intercom](./intercom): Trigger based on customer conversations and publish to Intercom help center
