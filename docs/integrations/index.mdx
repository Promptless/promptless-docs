...
- [Bitbucket](./bitbucket): Trigger based on Pull Requests and publish documentation to Bitbucket repositories
...
- [Document360](./document360): Publish documentation updates to Document360's knowledge base
- [Paligo](./paligo): Publish documentation updates to Paligo's technical documentation platform
