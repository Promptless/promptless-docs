...
Promptless uses Webflow's [official API](https://developers.webflow.com/) with API token authentication and site-specific access controls. You can revoke access at any time through your Webflow settings.

For detailed security information, see our [Security and Privacy documentation](/security-and-privacy).

For questions about the Webflow integration, contact help@gopromptless.ai.