...
You can configure Promptless to exclude specific directories from its analysis and suggestions. This is useful for directories containing files with special formatting requirements or that you prefer to manage manually, such as changelog directories. This setting can be configured in your project settings.

<img src="/img/exclude-directories.png" alt="Excluding Directories from Promptless Suggestions" style={{width:"800px", display: "block", margin: "0 auto", marginBottom: "20px", boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)"}} />
