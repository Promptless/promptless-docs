...
When reviewing changes in the Promptless dashboard, you have several options to customize the documentation updates:
- For new files, you can edit the filename directly by clicking the edit icon next to the file
- You can move files to different locations using the move file option
- You can modify the content of any file before approving the changes
