...
You can customize how Promptless creates pull requests by configuring a PR template path in your project settings. This path should point to your PR template file (e.g., `.github/PULL_REQUEST_TEMPLATE.md`) in your documentation repository. When specified, Promptless will use this template when creating documentation update PRs, ensuring that automated documentation updates follow your team's PR conventions and include all necessary sections.
